...
//    ESP_LOGI("", "Clock divider is %d", lcd_clkm_div_num);     
    ...
    if (_cfg.psram_clk_override) 
    {
        ...
        LCD_CAM.lcd_clock.lcd_clkm_div_num = 11; // 13Mhz is the fastest output from PSRAM if we want to be able to service other peripherals as well.
    }
    else
    {
...
/*critical changes made*/
  ...
  void IRAM_ATTR Bus_Parallel16::flip_dma_output_buffer(int back_buffer_id)
  {
