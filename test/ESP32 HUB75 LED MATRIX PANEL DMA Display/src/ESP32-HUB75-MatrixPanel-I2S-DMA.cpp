...
{
  if (x_coord >= PIXELS_PER_ROW || y_coord >= m_cfg.mx_height) return;

  uint16_t red16 = red * 0x101;
  uint16_t green16 = green * 0x101;
  uint16_t blue16 = blue * 0x101;
